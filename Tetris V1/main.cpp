...
//new theory have 2 var, leftlowestPoint & rightlowestPoint. This gets compared to DistanceToGroundLeft & DistanceToGroundRight; The tiniest one will dictate if col[k]+1 or col[k];
    ...
    int rowCal;
    int rowplace = 0;
    int lowestPoint = Bricks[0].getPosition().y;
    int distanceToGroundLeft;
    int distanceToGroundRight;
    int temp;

      for(int i=0; i<Bricks.size(); i++) {

        if(Bricks[i].getPosition().y>lowestPoint && Bricks[i].getPosition().y >0) {
            lowestPoint = Bricks[i].getPosition().y;
        }
    }

        for(int i = 0; i<8; i++) {

        if(lowestPoint == Bricks[i].getPosition().y) {

            temp = i;
        }
    }

lowestPoint = (int)Bricks[temp].getPosition().y/10;
            ...
            for(int i = 0; i<places.size(); i++) {
                ...
                if(places[i].getPosition().x == Bricks[row[j]].getPosition().x && places[i].getPosition().y == Bricks[row[j]].getPosition().y ) {
                    ...
                    rowCal = (int)Bricks[row[j]].getPosition().x%10;
                        ...
                        if(col[k]>lowestPoint){
                        if(GameMatrix[rowCal][col[k]] > 0) {
                    cout<<"A "<<rowCal<<" "<<col[k]<<" "<<lowestPoint<<endl;
            ...
            for(int i = 0; i<places.size(); i++) {
                ...
                if(places[i].getPosition().x == Bricks[row[j]].getPosition().x && places[i].getPosition().y == Bricks[row[j]].getPosition().y ) {
                    ...
                    rowCal = (int)Bricks[row[j]].getPosition().x%10;
                        ...
                        if(GameMatrix[rowCal][col[k]+1] > 0) {

                            cout<<"B "<<rowCal<<" "<<col[k]<<" "<<lowestPoint<<endl;
                            return true;
...
//[col][row]
    ...
    int temp = Bricks[0].getPosition().y;
    ...
    for(int i=0; i<Bricks.size(); i++) {
        ...
        if(Bricks[i].getPosition().y>temp && Bricks[i].getPosition().y >0) {
    ...
    for(int i = 0; i<8; i++) {
        ...
        if(temp == Bricks[i].getPosition().y) {
    ...
    for(int i = 0; i < places.size(); i++) {
        ...
        if(places[i].getPosition().y == temp) {
...
int main() {
    ...
    */
    ...
    CurrentColour = sf::Color(rand()%255,rand()%255,rand()%255);
        ...
        */
        ...
        if(whereFloor(Bricks,GameMatrix,places) == true) {
            ...
            if(LeftRightTimer > 20) {
                ...
                CurrentColour = sf::Color(rand()%155+50,rand()%155+50,rand()%155+50);
